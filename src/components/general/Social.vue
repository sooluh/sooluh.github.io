<template functional>
  <ul class="social" :class="[data.class, data.staticClass]">
    ...
    <li class="collection" group="Sosial">
      <a
        class="item"
        aria-label="Twitter"
        style="--hovcol: #1da1f3"
        href="https://twitter.com/suluh_s"
        target="_blank"
        ><svg
          aria-hidden="true"
          focusable="false"
      ...
      <a
        ...
        aria-label="YouTube"
        style="--hovcol: #ff0000"
        href="https://www.youtube.com/c/SDeveloper"
        target="_blank"
        ><svg
          aria-hidden="true"
          focusable="false"
      ...
      <a
        ...
        aria-label="LinkedIn"
        style="--hovcol: #0a66c2"
        href="https://www.linkedin.com/in/suluhs/"
        target="_blank"
        ><svg
          aria-hidden="true"
          focusable="false"
...
$color-social-grouping: $color-dark-secondary;
...
.collection {
  ...
  &::after {
    ...
    left: 50%;
    height: 0.25rem;
    background: $color-social-grouping;
  }
}
